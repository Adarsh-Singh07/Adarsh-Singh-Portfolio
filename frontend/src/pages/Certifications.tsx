...
const AWSLogo = ({ className = "w-7.5 h-7.5" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 80 48" xmlns="http://www.w3.org/2000/svg">
    <path fill="#FF9900" d="M57.6 34.3c-7.9 5.8-19.4 8.9-29.3 8.9-13.8 0-26.2-5.1-35.5-13.6-.8-.7-.1-1.7.9-1.2 10.1 5.8 22.5 9.2 35.3 9.2 8.7 0 17.8-2 25.9-6.3 1.3-.7 2.4.9 1.7 2.2z"/>
    <path fill="#FF9900" d="M61 31.5c-.8-1-5.2-.5-7.2-.2-.6.1-.7-.5-.2-.9 3.5-2.5 9-1.8 9.9.2.8 1.8-.5 7.6-3.8 10.4-.5.5-1 .2-.8-.4.7-2 2.1-8.1 2.1-9.1z"/>
    <path fill="#FF9900" d="M21.5 22.8c0 2-.3 3.5-1.1 4.6-1 .1.2-2.2 1.7-3.8 1.7-1.1 0-2.1-.3-2.9-1s-1.2-1.7-1.2-3.1c0-1.4.4-2.6 1.2-3.3s1.8-1.1 3-1.1c1.2 0 2.2.4 2.9 1.1s1.1 1.9 1.1 3.4zm-4 0c0-1.3-.2-2.2-.5-2.7s-.8-.8-1.5-.8-.13.3-1.6.8-.4 1.4-.4 2.7.1 2.1.4 2.7.8.8 1.5.8 1.2-.3 1.5-.8.5-1.4.5-2.7z"/>
  </svg>
);
